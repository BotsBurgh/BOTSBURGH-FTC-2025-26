...
@Autonomous(name = "autoCloseBlue (12 ball)")
class autoCloseBlue9: LinearOpMode() {
    override fun runOpMode() {
        ...
        Turret.changeTargetVelocity(sqrt(((RobotConfig.UniversalCoordinates.BLUE_POS[0] - (5.09*12).squared()) + (RobotConfig.UniversalCoordinates.BLUE_POS[1] - (7.11*12).squared()))))
        Turret.launch()
